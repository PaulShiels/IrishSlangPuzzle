...
namespace IrishSlangPuzzle
{
    public partial class MainPage : PhoneApplicationPage, INotifyPropertyChanged
    {
        ...
        public MainPage()
        {
            ...
            //item.ItemName = user.name;
            //toDoDB.ToDoItems.InsertOnSubmit(item);
            //toDoDB.SubmitChanges();
            
            var name = from n in toDoDB.ToDoItems
                       select n;

            foreach (var i in name)
            {
                toDoDB.ToDoItems.DeleteOnSubmit(i);
            }

            toDoDB.SubmitChanges();

            //lbxUsers.Items.Add(name.ToString());
    ...
    public class ToDoDataContext : DataContext
    {
        ...
        public Table<IrishSlangPuzzle.MainPage.ToDoItem> ToDoItems;
    }
}